...
$(document).ready(function () {
    ...
    if (prosledjeno.src !== "" && prosledjeno.src != null && localStorage.getItem("Prosledjeno")!=="") {
        ...
        prosledjeno.src = "";
        localStorage.setItem("Prosledjeno","");
...
function postavi(red, niz) {
    ...
    for (var i = 0; i < niz.length; i++) {
        var artikal = niz[i];
        console.log(artikal);
        if(artikal.sifraartikla==undefined)
            artikal.sifraartikla=artikal.sifraartikla_id;
        ...
        if(artikal.idkat==undefined)
            cena1.textContent = (artikal.cena * (100 + artikal.pdv) / 100).toFixed(2) + ' din' ;
        else
